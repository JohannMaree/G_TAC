This is the binary Software Development Kit (SDK) for Gmsh 4.6.0:
  ...
  * Build options: 64Bit ALGLIB Ann Bamg Blas[custom] Blossom Cgns DIntegration DomHex Fltk Gmm Hxt Jpeg[fltk] Kbipack Lapack[custom] MathEx Med Mesh Metis Mmg3d Mpeg Netgen NoSocklenT ONELAB ONELABMetamodel OpenCASCADE OpenCASCADE-CAF OpenGL OptHom PETSc Parser Plugins Png[fltk] Post QuadTri Solver TetGen/BR Voro++ Zlib[fltk]

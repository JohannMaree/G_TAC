...
### GetDP
GetDP[(1)](#1-getdp)(*General environment for the treatment of Discrete Problems*) is a free, open source finite element solver capable of using mixed elements to solve de Rham complexes in one, two and three dimensions.
...
### Gmsh
Gmsh[(2)](#2-gmsh) is a free finite element mesh generator with a built-in CAD engine and post-processor. 
...
### ONELAB
ONELAB[(3)](#3-onelab)(*Open Numerical Engineering LABoratory*) provides an open-source graphical user interface to the Gmsh and GetDP finite element software.
